...
#
def u15m_preceding_high(_detail_df, _used_len, _date, _n1, _n2, _db):
    idx = 0
    days = 0
    to_start = False
    to_count = False
...
#
def u15m_preceding_low(_detail_df, _used_len, _date, _n1, _n2, _db):
    idx = 0
    days = 0
    low_date = ""
    to_start = False
...
# X点往前n1单位内的最高high价
#
def u15m_preceding_high2(_detail_df, _used_len, _date, _n1, _db):
    idx = 0
    days = 0
    to_start = False
    to_count = False
...
# X点往前n1单位内最高价连续走低的天数
#
def u15m_desceding_days(_detail_df, _used_len, _date, _n1, _db):
    idx = 0
    days = 0
    to_start = False
    to_count = False
...
# 最高价
#
def u15m_break_days(_detail_df, _used_len, _date, _my_high, _db):
